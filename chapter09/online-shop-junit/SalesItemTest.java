...
public class SalesItemTest
{
    ...
    public void setUp()
    {
        salesIte1 = new SalesItem("asdf", 2);
    }
    ...
    public void testDuplicateComment()
    {
        SalesItem salesIte1 = new SalesItem("Brain surgery for Dummies", 21998);
        assertEquals(true, salesIte1.addComment("James Duckling", "This book is great. I perform brain surgery every week now.", 4)); 
        assertEquals(false, salesIte1.addComment("James Duckling", "return false", 1));
    }
    
    @Test 
    public void testBoundariesRating()
    {
        SalesItem salesIte1 = new SalesItem("Brain surgery for Dummies", 21998);
        assertEquals(false, salesIte1.addComment("Jimmmmmie Duckling", "This book is great. I perform brain surgery every week now.", 0)); 
        assertEquals(false, salesIte1.addComment("James Duckling", "This book is great. I perform brain surgery every week now.", 6)); 
    }
    @Test
    public void testHelpComment()
    {
        SalesItem salesIte1 = new SalesItem("Brain surgery for Dummies", 21998);
        salesIte1.addComment("james", "asdf", 2);
        salesIte1.addComment("asdf", "fdasdf", 2);
